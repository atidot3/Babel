...
unsigned char		*EncodeAudio::encodeAudio(const SAMPLE *frame, int *retenc)
{
	if (this->_len)
	{
...
void		EncodeAudio::decodeAudio(const unsigned char *data, SAMPLE *out, int retenc)
{
	int		ret;
